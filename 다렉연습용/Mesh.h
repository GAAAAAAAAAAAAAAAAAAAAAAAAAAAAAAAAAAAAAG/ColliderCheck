...
public:
	//추가
	UINT							m_nMeshColliders = 0;
	UINT							*m_pnMeshColliders = NULL;
...
public:
	...
	bool CheckOBBMeshCollision(const BoundingOrientedBox& playerOBB, CMesh* pOtherMesh, const XMFLOAT4X4& worldMatrix1, const XMFLOAT4X4& worldMatrix2);
